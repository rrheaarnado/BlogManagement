import { Bars3Icon, CalendarDateRangeIcon, MagnifyingGlassIcon, PlusIcon, XMarkIcon } from "@heroicons/react/24/outline";
...
const SearchBar = ({ onAdd, setSearchQuery, onSort }) => {
  ...
  const handleSort = (option) => {
    setSortBy(option);
    onSort(option); //pass to parent => Homepage
  }
      ...
      <div className="flex gap-2 bg-white border border-gray-200 rounded-lg p-3 items-center shadow-sm">
        ...
        <div className="relative inline-block text-left group">
          <div className="hover:bg-gray-100 hover:text-white rounded-lg border border-gray-200">
            <button
              onClick={() => setIsSortOpenModal(true)}
              className="flex items-center gap-2 text-black py-2 px-4 rounded-xl whitespace-nowrap cursor-pointer"
            >
          ...
          <div className="absolute left-0 mt-1 w-40 bg-white border border-gray-200 rounded-lg shadow-lg 
